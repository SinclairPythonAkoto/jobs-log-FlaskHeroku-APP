...
7. Now in your orginal Bash window, create a new Heroku App by 'heroku create HEROKU-APP'.  You will recieve a Herokuapp https & your GitHub repository (the original).  You can always check on your remote by 'git remote -v'.  This will also show you your Heroku & Git connection.
